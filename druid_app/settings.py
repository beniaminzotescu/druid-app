"""
Django settings for druid_app project.
...
ALLOWED_HOSTS = ['testing-factory.azurewebsites.net', '127.0.0.1', 'druidpartners.druidqa.druidplatform.com']
...
WSGI_APPLICATION = 'druid_app.wsgi.application'
